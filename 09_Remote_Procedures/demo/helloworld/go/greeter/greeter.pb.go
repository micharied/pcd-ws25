...
const file_greeter_proto_rawDesc = "" +
	...
	"\x05Sayer\x126\n" +
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply2?\n" +
	"\x05Asker\x126\n" +
	"\bAskHello\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReplyB\x17\n" +
	"\agreeterZ\fdemo/greeterb\x06proto3"
...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: greeter.Sayer.SayHello:input_type -> greeter.HelloRequest
	0, // 1: greeter.Asker.AskHello:input_type -> greeter.HelloRequest
	1, // 2: greeter.Sayer.SayHello:output_type -> greeter.HelloReply
	1, // 3: greeter.Asker.AskHello:output_type -> greeter.HelloReply
